...
/**
 * Defines a [route](https://liaison.dev/docs/v1/reference/route) for a static method in a [routable component](https://liaison.dev/docs/v1/reference/routable#routable-component-class).
 *
 ...
 *
 * And if the defined `route` is controlled by a [`router`](https://liaison.dev/docs/v1/reference/router), you also get the following shortcut functions:
 *
