...
/**
 * Defines a [route](https://liaison.dev/docs/v1/reference/route) for a class method in a [routable component](https://liaison.dev/docs/v1/reference/routable#routable-component-class).
 *
 ...
 *
 * - `Home.matchURL(url)` is the equivalent of [`route.matchURL(url)`](https://liaison.dev/docs/v1/reference/route#match-url-instance-method).
 * - `Home.generateURL(params, options)` is the equivalent of [`route.generateURL(params, options)`](https://liaison.dev/docs/v1/reference/route#generate-url-instance-method).
 *
 * If the defined `route` is controlled by a [`router`](https://liaison.dev/docs/v1/reference/router), you also get the following shortcut functions:
 *
 * - `Home.navigate(params, options)` is the equivalent of [`router.navigate(url, options)`](https://liaison.dev/docs/v1/reference/router#navigate-instance-method) where `url` is generated by calling [`route.generateURL(params, options)`](https://liaison.dev/docs/v1/reference/route#generate-url-instance-method).
 * - `Home.redirect(params, options)` is the equivalent of [`router.redirect(url, options)`](https://liaison.dev/docs/v1/reference/router#redirect-instance-method) where `url` is generated by calling [`route.generateURL(params, options)`](https://liaison.dev/docs/v1/reference/route#generate-url-instance-method).
 * - `Home.reload(params, options)` is the equivalent of [`router.reload(url)`](https://liaison.dev/docs/v1/reference/router#reload-instance-method) where `url` is generated by calling [`route.generateURL(params, options)`](https://liaison.dev/docs/v1/reference/route#generate-url-instance-method).
 * - `Home.isActive(params)` returns a boolean indicating whether the `route`'s URL (generated by calling [`route.generateURL(params)`](https://liaison.dev/docs/v1/reference/route#generate-url-instance-method)) matches the current `router`'s URL.
 *
 * Lastly, if the defined `route` is controlled by a [`router`](https://liaison.dev/docs/v1/reference/router) that is created by using the [`useBrowserRouter()`](https://liaison.dev/docs/v1/reference/react-integration#use-browser-router-react-hook) React hook, you also get the following shortcut function:
 *
 * - `Home.Link({params, hash, ...props})` is the equivalent of [`router.Link({to, ...props})`](https://liaison.dev/docs/v1/reference/browser-router#link-instance-method) where `to` is generated by calling [`route.generateURL(params, {hash})`](https://liaison.dev/docs/v1/reference/route#generate-url-instance-method).
 *
 * @examplelink See an example of use in the [`BrowserRouter`](https://liaison.dev/docs/v1/reference/browser-router) class.
 *
 * @category Decorators
 * @decorator
 */
