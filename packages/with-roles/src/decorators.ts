...
/**
 * Defines a [role](https://liaison.dev/docs/v1/reference/role) in a [`ComponentWithRoles`](https://liaison.dev/docs/v1/reference/with-roles#component-with-roles-class) class or prototype.
 *
 ...
 *
 * @examplelink See an example of use in the [`WithRoles()`](https://liaison.dev/docs/v1/reference/with-roles#with-roles-mixin) mixin.
 *
 * @category Decorators
 * @decorator
 */
