...
/**
 * Deeply merge any type of forks including objects, arrays, and components (using Component's `merge()` [class method](https://liaison.dev/docs/v1/reference/component#merge-class-method) and [instance method](https://liaison.dev/docs/v1/reference/component#merge-instance-method)) into their original values.
 *
 ...
 * @example
 * ```
 * import {fork, merge} from '﹫liaison/component';
 *
 * const data = {
 *   token: 'xyz123',
